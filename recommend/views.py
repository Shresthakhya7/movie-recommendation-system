...
def register(request):
    if request.method =="POST":
        ...
        file_path = 'C:/Users/Administrator/Desktop/final7/movie/rate.csv'
...
def addmovie(request):
    ...
    genres = set()
    with open('C:/Users/Administrator/Desktop/final7/movie/movie.csv', newline='', encoding='utf-8') as csvfile:
...
csv_file_path = os.path.join(settings.BASE_DIR, 'C:/Users/Administrator/Desktop/final7/movie/movie.csv')
...
import_ratings_from_csv('C:/Users/Administrator/Desktop/final7/movie/rate.csv')
